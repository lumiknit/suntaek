...
`.trim();
  ...
  const handleRunButtonClick = () => {
    ...
    toast.promise(f(), {
      loading: "Running LLM...",
      success: "Successfully generated by LLM!",
      error: "Failed to run LLM, please check the error message",
    });
  };
...
{#if config !== undefined}
  ...
  <label>
    Your Request
    <textarea placeholder="Your prompt here." bind:value={userPrompt} />
  </label>

  <label>
    System Prompt
    <textarea placeholder="System prompt here." bind:value={systemPrompt} />
  </label>
  ...
  <label>
    API Key (<a href={apiKeyURL} target="_blank">Get from here!</a>)
